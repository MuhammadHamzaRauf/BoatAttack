...
#pragma warning restore 0649
        ...
        private SoundManagerS _soundManager;
        internal SoundManagerS SoundManager
        {
            get
            {
                ...
                return ReturnError<SoundManagerS>();
            }
        }
        ...
        internal void Initialize(Transform[] activeCameras, int nrOfVehicles, VehiclePool vehiclePool, TrafficOptions trafficOptions)
        {
            ...
            _soundManager = new SoundManagerS(trafficOptions.masterVolume);
